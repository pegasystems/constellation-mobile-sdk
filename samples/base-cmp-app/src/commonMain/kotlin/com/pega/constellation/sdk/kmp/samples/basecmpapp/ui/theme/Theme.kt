...
//    secondaryFixed = Color(red = 232, green = 222, blue = 248),
//    onSecondaryFixed = Color(red = 29, green = 25, blue = 43)
)

/** Brand gradient (purple → indigo → pink) for hero surfaces and accents. */
val MediaCoBrandGradient: Brush
...
val MediaCoAuroraGradient: Brush
    @Composable get() = Brush.linearGradient(
        colors = listOf(
            Color(0x774338CA),
            Color(0x00312E81),
...
private val MediaCoTypography = Typography(
    ...
    headlineMedium = TextStyle(fontSize = 24.sp, lineHeight = 32.sp, fontWeight = FontWeight.SemiBold, letterSpacing = (-0.25).sp),
