...
/*
 * Provides convenient way of reading properties from Info.plist of the application.
 */
class SDKConfiguration {

    private init() {} // use static methods
    ...
    static var debuggable: Bool {
        Bundle.main.infoDictionary?["Debuggable"] as? Bool ?? false
    }
}
