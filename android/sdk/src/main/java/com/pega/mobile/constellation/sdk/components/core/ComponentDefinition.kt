 ...
 *
 * @property type type of the component. It can be built-in type defined in [com.pega.mobile.constellation.sdk.components.ComponentTypes] or custom type.
 ...
 *
 * @see [com.pega.mobile.constellation.sdk.components.Components.DefaultDefinitions]
 */
