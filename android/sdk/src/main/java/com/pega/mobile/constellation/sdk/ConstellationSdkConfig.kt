 ...
 *
 * @param pegaUrl URL to Pega server e.g.: *https://lab-05423-bos.lab.pega.com/prweb*
 * @param pegaVersion version of Pega server e.g.: *8.24.1*. Determines Constellation Core JS library version used by SDK.
 * @param okHttpClient (optional) - instance of OkHttpClient which can be passed to SDK for advanced networking control.
