...
android {
    namespace = "com.pega.mobile.constellation.sample"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.pega.mobile.constellation.sample"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
        ...
        manifestPlaceholders["appAuthRedirectScheme"] = "com.pega.mobile.constellation.sample"
    }
