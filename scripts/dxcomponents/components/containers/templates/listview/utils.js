import { getDefaultViewMeta } from "./DefaultViewMeta.js";
        ...
        const uncommonFieldsList = primaryFields.filter(
            (primaryField) =>
                !presetConfigFields.some(
                    (presetConfigField) => presetConfigField.config.value.split(".")[1] === primaryField
                )
        );
...
export function initializeColumns(fields = [], getMappedProperty = null) {
