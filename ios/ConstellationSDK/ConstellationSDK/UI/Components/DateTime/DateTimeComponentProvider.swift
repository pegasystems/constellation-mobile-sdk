...
open class DefaultDateTimeComponentProvider: ComponentProvider {

    public let view: AnyView
    public let properties: DateTimeProps
    ...
    public required init() {
        ...
        view = AnyView(DateTimeView(properties: properties))
...
fileprivate struct DecodableDateTimeProps: Decodable {
    let value: String
    let label: String
    ...
    func apply(to observableProps: DateTimeProps) {
        observableProps.timeZone = timeZone
